...
| \<chr\>  | \<dbl\>   | \<dbl\>   |       |       |
+----------+-----------+-----------+-------+-------+
| model_u1 | -2581.436 | -2567.673 |       |       |
+----------+-----------+-----------+-------+-------+
| model_u2 | -2838.792 | -2825.030 |       |       |
+----------+-----------+-----------+-------+-------+
| model_u3 | -2610.900 | -2597.137 |       |       |
+----------+-----------+-----------+-------+-------+
...
stargazer(
  ...
  covariate.labels = c("Fitted Density Squared", "Collective Bargain Coverage", "Inflation", "Wage Growth", 
                       "Net Export"),
  omit = c("factor\\(Country\\)", "factor\\(Year\\)"), 
  omit.labels = c("Country", "Year"), 
  star.cutoffs = c(0.1, 0.05, 0.01),
...
stargazer(
  ...
  covariate.labels = c("Density Squared", "Collective Bargain Coverage", "Inflation", 
                       "Wage Growth", "Female Workers", "Log Minimum Wage","Log GDP"),
...
stargazer(
  ...
  covariate.labels = c("Trade Unions Density", "Collective Bargain Coverage", "Density * Cluster 2", 
                       "Density * Cluster 3", "Inflation", "Wage Growth", "Log Minimum Wage",
                       "Log GDP", "Government Debt", "Log Labor", "Female Workers", 
                       "Part-time Employment", "Women Unemployment Rate", "Net Export", 
                       "Net FDI", "Tax Contribution"),
  omit = c("factor\\(Country\\)", "factor\\(Year\\)"), 
  omit.labels = c("Country", "Year"), 
  star.cutoffs = c(0.1, 0.05, 0.01),
  no.space = TRUE, 
